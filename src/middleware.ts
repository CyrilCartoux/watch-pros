...
const PUBLIC_ROUTES = ['/auth', '/register', '/subscription', '/pricing' , '/terms', "/help", "/about", "/manifest.webmanifest"]
...
export async function middleware(request: NextRequest) {
  ...
  try {
    ...
    if (path === '/') {
      return NextResponse.redirect(new URL('/listings?listingType=watch', request.url))
    }
...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|public|api|images).*)',
  ],
}